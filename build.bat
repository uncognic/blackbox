...
clang-cl /D_CRT_NONSTDC_NO_WARNINGS /D_CRT_SECURE_NO_WARNINGS /I "%SRC%\blackboxc" "%SRC%\blackboxc\compiler.c" "%SRC%\blackboxc\asm.c" "%SRC%\blackboxc\basic.c" "%SRC%\blackboxc\tools.cpp" "%SRC%\data.c" bcrypt.lib /Fe:"%ROOT%\bbxc.exe"
if errorlevel 1 (
...
clang-cl /D_CRT_NONSTDC_NO_WARNINGS /D_CRT_SECURE_NO_WARNINGS /I "%SRC%\blackbox" /I "%SRC%\blackboxc" "%SRC%\blackbox\blackbox.c" "%SRC%\blackbox\debug.c" "%SRC%\blackboxc\tools.cpp" "%SRC%\data.c" bcrypt.lib /Fe:"%ROOT%\bbx.exe"
if errorlevel 1 (
