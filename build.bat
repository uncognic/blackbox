...
clang-cl /D_CRT_NONSTDC_NO_WARNINGS /D_CRT_SECURE_NO_WARNINGS /I "%SRC%\blackboxc" "%SRC%\blackboxc\compiler.c" "%SRC%\blackboxc\asm.c" "%SRC%\blackboxc\basic.cpp" "%SRC%\blackboxc\tools.cpp" "%SRC%\data.cpp" bcrypt.lib /Fe:"%ROOT%\bbxc.exe"
if errorlevel 1 (
